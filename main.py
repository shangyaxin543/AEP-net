...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default='./train/l/')
    parser.add_argument('--target_path', type=str, default='./train/h/')
    ...
    parser.add_argument('--test_iters', type=int, default=20000) # 440000
